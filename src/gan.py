...
class DCGAN():
    ...
    def train(self, epochs):
        ...
        self.plot_losses(G_losses, D_losses, save_dir='../models/dcGan/losses', filename=f'loss_plot_final.png')

        print('Training finished.')

    def plot_losses(self, G_losses, D_losses, save_dir, filename):
